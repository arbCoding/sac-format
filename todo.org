...
*** TODO data2 read/write :unit:
*** TODO not =equal_within_tolerance= :unit:
*** TODO =legacy_write= read/write :unit:
** TODO Improved functionality :functionality: :refactor:
...
*** TODO CPPLint workflow
*** TODO Infer static analysis
#+begin_src bash :eval no
cmake --preset clang-release
infer run -- cmake --build ./build/release/clang/
#+end_src
* Inbox
