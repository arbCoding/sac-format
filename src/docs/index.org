...
--------------
* Introduction
sac-format is a single-header C++ library designed to make working with binary
[[https://ds.iris.edu/files/sac-manual/manual/file_format.html][SAC]]-files as easy as possible. I wrote sac-format in the 2020 standard of the
...
with =v6= and =v7= SAC-files and can automatically detect which on read. File output
defaults to =v7= SAC-files and there is a legacy-write function for =v6= output.
*** Low-level I/O
