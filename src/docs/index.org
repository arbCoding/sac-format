...
with binary [[https://ds.iris.edu/files/sac-manual/manual/file_format.html][SAC]]-files as easy as possible. It is written in the 2020 standard of
...
sac-format is being actively developed on [[https://github.com/arbCoding/sac-format][GitHub]]!
...
#+end_src
*** Use
To use, simply link to the compiled library (=libsac-format.a= on Linux/macOS,
...
fit.
** Dependencies
The only dependency is on [[https://www.boost.org/users/history/version_1_83_0.html][boost 1.83.0]].
** Endianness
